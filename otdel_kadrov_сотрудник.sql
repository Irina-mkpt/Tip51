...
--
-- Host: 127.0.0.1    Database: otdel_kadrov
-- ------------------------------------------------------
...
CREATE TABLE `сотрудник` (
  ...
  PRIMARY KEY (`id`),
  KEY `Должность` (`Должность`),
  CONSTRAINT `сотрудник_ibfk_1` FOREIGN KEY (`Должность`) REFERENCES `должность` (`id`)
...
-- Dump completed on 2020-12-10 15:15:26
